...
#define IMGUI_DEBUG_LOG_ERROR(...)          (0)
#define IMGUI_DEBUG_LOG_ACTIVEID(...)       (0)
#define IMGUI_DEBUG_LOG_FOCUS(...)          (0)
#define IMGUI_DEBUG_LOG_POPUP(...)          (0)
#define IMGUI_DEBUG_LOG_NAV(...)            (0)
#define IMGUI_DEBUG_LOG_SELECTION(...)      (0)
#define IMGUI_DEBUG_LOG_CLIPPER(...)        (0)
#define IMGUI_DEBUG_LOG_IO(...)             (0)
#define IMGUI_DEBUG_LOG_FONT(...)           (0)
#define IMGUI_DEBUG_LOG_INPUTROUTING(...)   (0)
...
#define IM_ASSERT_USER_ERROR(_EXPR,_MSG)    (0)    // Recoverable User Error
#endif
